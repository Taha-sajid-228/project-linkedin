    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-4 flex-1">
          {/* Brand Logo */}
          <div className="flex items-center gap-2 cursor-pointer" onClick={onGoProfile}>
        ...
        <nav className="flex items-center gap-6">
          <button className="flex flex-col items-center justify-center text-slate-500 hover:text-indigo-600 transition-colors cursor-pointer group">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider hidden sm:inline mt-1">Home</span>
          </button>
          ...
          <button className="flex flex-col items-center justify-center text-slate-500 hover:text-indigo-600 transition-colors cursor-pointer">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider hidden sm:inline mt-1">Network</span>
          </button>
          ...
          <button className="flex flex-col items-center justify-center text-slate-500 hover:text-indigo-600 transition-colors cursor-pointer">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider hidden sm:inline mt-1">Jobs</span>
          </button>
          ...
          <div className="border-l border-slate-200 pl-4 flex items-center gap-3">
            <div className="flex items-center gap-2">
              {user?.profile_picture ? (
                ...
                <div className="h-8 w-8 rounded-full bg-gradient-to-br from-indigo-500 to-purple-650 text-white font-bold flex items-center justify-center text-xs shadow-xs">
                  {user?.username?.substring(0, 2).toUpperCase()}
                </div>
              )}

              <div className="hidden lg:block text-left">
                <p className="text-xs font-bold leading-none text-slate-800">{user?.username}</p>
